...
<template>
  <aside
    ...
    class="bg-white dark:bg-gradient-to-b dark:from-[#0d1117] dark:to-[#060a10] flex flex-col text-sm pb-px fixed top-0 ltr:left-0 rtl:right-0 h-full z-40 w-[200px] md:w-auto md:relative md:flex-shrink-0 md:ltr:translate-x-0 md:rtl:translate-x-0 ltr:border-r rtl:border-l border-[#E5E7EB] dark:border-[#1a2035]"
    :class="[
      {
  ...
  >
    ...
    >
      ...
      >
        ...
        <template v-else>
          <div class="flex flex-col gap-2 w-full">
            <div
              class="flex items-center justify-center px-3 py-3 mx-1 rounded-xl bg-[rgba(59,99,168,0.06)] border border-[#3B63A8]/20 dark:bg-gradient-to-br dark:from-[#1e3060]/60 dark:to-[rgba(59,99,168,0.05)] dark:border-[#3B63A8]/40 dark:shadow-[0_0_30px_rgba(59,99,168,0.15),inset_0_1px_0_rgba(255,255,255,0.04)]"
            >
              <Logo class="h-14 w-auto max-w-[160px]" />
            </div>
            <div
              class="w-full h-px bg-gradient-to-r from-transparent via-[#3B63A8]/20 dark:via-[#3B63A8]/30 to-transparent"
            />
            <SidebarAccountSwitcher
      ...
      >
        <RouterLink
          ...
          :to="{ name: 'search' }"
          class="flex gap-2 items-center px-2 py-1 w-full h-7 rounded-lg outline outline-1 outline-[#E5E7EB] bg-[#F9FAFB] dark:outline-[#2a3050] dark:bg-[#161b2e] transition-all duration-100 ease-out"
        >
    ...
    >
      <div
        class="pointer-events-none absolute inset-x-0 -top-[1.938rem] h-8 bg-gradient-to-t from-white dark:from-[#060a10] to-transparent"
      />
      ...
      />
      <div
        class="px-1 py-1.5 flex-shrink-0 flex w-full z-50 gap-2 items-center border-t border-[#E5E7EB] dark:border-[#1a2035] dark:shadow-[0px_-4px_16px_0px_rgba(0,0,0,0.3)]"
