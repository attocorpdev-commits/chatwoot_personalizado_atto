...
<template>
  ...
  >
    ...
    <div
      ...
      v-show="!scrollEnd"
      class="absolute bg-gradient-to-t from-[#060a10] w-full h-12 to-transparent -bottom-1 pointer-events-none flex items-end justify-end px-2 animate-fade-in-up"
    >
      <svg
        width="16"
        height="24"
